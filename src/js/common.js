...
var common = (function() {
	...
	function handleError(event) {
		...
		let event1 = new CustomEvent('nacl.error', {detail:{message: moduleEl.lastError}});
	...
	function handleCrash(event) {
		...
		let event1 = new CustomEvent('nacl.error', {detail:{message: msg}});
		document.dispatchEvent(event1)
	}
	...
	function moduleDidLoad() {
		...
		hideModule();
		let event = new CustomEvent('nacl.available', {detail:{message: msg}});
...
// listen to the notification to trigger NaCl stuff
//
